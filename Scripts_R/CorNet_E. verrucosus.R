...
corr_net("verrnew.txt",main="IM",cut=0.50,seed=1324123,method="pearson",na.cor="complete.obs")
corr_net("verrnew.txt",main="IM",cut=0.50,seed=1324123,method="spearman",na.cor="complete.obs")

# compare following with Fig 3b in MS
corr_net("verrnew.txt",main="MR",cut=0.50,seed=1324123,method="pearson",na.cor="complete.obs")
corr_net("verrnew.txt",main="MR",cut=0.50,seed=1324123,method="spearman",na.cor="complete.obs")
